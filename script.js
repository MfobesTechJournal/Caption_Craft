...
function getPlatformIcon(platform) {
    switch (platform.toLowerCase().replace(/[^a-z0-9]/g, '')) {
        case 'instagram':
            return `
                <svg class="icon instagram-icon" width="32" height="32" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 
                    10-10S17.52 2 12 2zm3.5 14h-7a1 1 0 01-1-1v-7a1 1 0 
                    011-1h7a1 1 0 011 1v7a1 1 0 01-1 1zM16 8.5a.5.5 
                    0 100-1 .5.5 0 000 1zM12 10a2 2 0 100 4 2 2 0 
                    000-4z"/>
                </svg>
            `;
        case 'x':
        case 'X':
            ...
            return `
                <svg class="icon x-icon" width="32" height="32" viewBox="0 0 24 24">
                    <path d="M18.9 2H21l-4.35 5.02L22 22h-5l-3.5-8.6L8.3 22H3l4.6-5.33L2 2h5l3.2 7.47L15.7 2h3.2zM8.44 4.17L4.96 18h2.67l3.5-4.08L14.8 18h2.68L10.52 4.17H8.44z"/>
                </svg>
            `;
        case 'linkedin':
            return `
                <svg class="icon linkedin-icon" width="32" height="32" viewBox="0 0 24 24">
                    <path d="M22.23 0H1.77C.8 0 0 .77 0 1.73v20.54C0 
                    23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 
                    1.77-1.73V1.73C24 .77 23.2 0 22.23 
                    0zM7.05 20.37H3.63V9.45h3.42v10.92zM5.34 
                    7.9c-1.15 0-1.85-.77-1.85-1.74s.67-1.73 
                    1.89-1.73c1.23 0 1.85.77 1.85 1.73 
                    0 .96-.66 1.74-1.89 1.74zM20.37 
                    20.37h-3.42v-5.6c0-1.34-.5-2.25-1.68-2.25-1.07 
                    0-1.7.72-1.98 1.41-.1.25-.13.58-.13.92v5.52H9.72s.05-9.87 
                    0-10.92h3.42v1.44c.46-.72 1.27-1.74 
                    3.08-1.74 2.25 0 3.93 1.47 3.93 
                    4.67v6.55z"/>
                </svg>
            `;
        default:
            return `
                <svg class="icon default-icon" width="32" height="32" viewBox="0 0 24 24">
                    <path d="M19 3H5c-1.1 0-2 .9-2 
                    2v14c0 1.1.9 2 2 
                    2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 
                    16H7v-1h10v1zm0-3H7V5h10v11z"/>
                </svg>
            `;
    }
}
